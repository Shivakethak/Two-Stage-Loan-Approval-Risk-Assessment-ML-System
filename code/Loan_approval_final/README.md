...
1. **Input Features**: `no_of_dependents`, `education`, `self_employed`, `income_annum`, `loan_amount`, `loan_term`, `cibil_score`, `residential_assets_value`, `commercial_assets_value`, `luxury_assets_value`, `bank_asset_value`.
2. **Stage 1 (Approval Classifier)**: Predicts whether the loan application is **Approved** or **Rejected**.
3. **Stage 2 (Amount Regressor)**: If Approved, Stage 2 triggers automatically to calculate the recommended maximum eligible loan amount.
